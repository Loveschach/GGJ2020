...
Shader "Screw/Alpha Outline" {
	Properties{
		...
		//_OutlineExtrusion("Outline width", Range(0.0, 0.15)) = .005
...
#include "UnityCG.cginc"
		...
		uniform half _OutlineExtrusion;
			...
			SubShader{
				...
				Pass {
					...
					v2f vert(appdata v) {
						...
						vertex.x *= _OutlineExtrusion + 1;
						vertex.y *= _OutlineExtrusion + 1;
						vertex.z *= _OutlineExtrusion + 1;
						vertex += _OutlineOffset;
